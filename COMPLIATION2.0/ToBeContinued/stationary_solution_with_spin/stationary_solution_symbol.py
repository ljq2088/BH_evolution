...
E1_simplification=exp_to_hyper(E1,B).doit().expand()
E2_simplification=exp_to_hyper(E2,B).doit().expand()
E3_simplification=exp_to_hyper(E3/sp.sin(theta),B).doit().expand()
E4_simplification=exp_to_hyper(E4,B).doit().expand()
E5_simplification=exp_to_hyper(E5,B).doit().expand()
E6_simplification=exp_to_hyper(E6,B).doit().expand()
E7_simplification=exp_to_hyper(E7,B).doit().expand()
E8_simplification=exp_to_hyper(E8,B).doit().expand()
E9_simplification=exp_to_hyper(E9/sp.sin(theta),B).doit().expand()
E10_simplification=exp_to_hyper(E10,B).doit().expand()
...
--------------------------------------------
"""
equations=sp.Array([E1_normalization,E2_normalization,E4_normalization,E5_normalization,E7_normalization])
fields=[chi,xi_tilde,f_tilde,A_tilde,phi_tilde]
